      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)(res.data.status, 'login successful');
...
var displayMap = exports.displayMap = function displayMap(location) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/nnanwobu/clniq1lpm00d001pi2vzsb8yp',
    scrollZoom: false,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)(res.data.status, 'data updated successfully');
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51O4KZKK4mclvTzynDHpPMprjsmtxcGeFRlIKxtkMvssItxYf7lJrhxZ1ei4v6wcdOD0HSU5Cv8lJUPUyTcdeY3Vf00Um2IGD8N');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v2/bookings/checkout-session/".concat(tourId)
          });
        case 3:
...
var userDataUpdateBtn = document.querySelector('.form-user-data');
var userSettingsBtn = document.querySelector('.form-user-settings');
var progress = document.querySelector('.savepass');
...
if (logoutBtn) {
  logoutBtn.addEventListener('click', function (e) {
    var clicked = e.target.closest('.nav__el--logout');
    if (!clicked) return;
    (0, _login.logout)();
  });
}
if (userDataUpdateBtn) {
  userDataUpdateBtn.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(form);
            _context.next = 8;
            return (0, _updatesetting.updateSettings)(form, 'userData');
          case 8:
...
if (userSettingsBtn) {
  userSettingsBtn.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            '', _readOnlyError("currentpassword");
